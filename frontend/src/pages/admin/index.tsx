...
type Tab = "dashboard" | "approvals" | "users" | "assessments" | "questions" | "generate" | "batches" | "results" | "interviews" | "interview-results";
...
export default function AdminHome() {
  ...
  const tabTitle = () => {
    switch (activeTab) {
      ...
      case "generate": return "AI Question Generation";
    ...
    <div className="flex h-screen bg-[var(--color-bg)]">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="p-8 max-w-[1200px]">
          ...
          {activeTab === "generate" && <QuestionGeneration topics={topics} setMessage={setMessage} />}
